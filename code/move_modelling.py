...
def main():
    ...
    shutil.move("data/STARD_raw/processed_data/final_xy_data_matrices/X_tillwk4_qids_sr__final.csv", "data/modelling/X_tillwk4_qids_sr__final.csv")
    shutil.move("data/STARD_raw/processed_data/final_xy_data_matrices/X_train_stard_extval.csv", "data/modelling/X_train_stard_extval.csv")
